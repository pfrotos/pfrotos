...
export default function ProcessSection() {
  ...
  return (
    ...
    // This removes the top gap but keeps space at the bottom for the next section
    <section id="process" className="pt-0 md:pt-0 pb-16 md:pb-32 px-4 md:px-6 bg-black">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl md:text-5xl font-light mb-8 md:mb-16 tracking-tight bg-gradient-to-r from-white to-[#3a82f5] bg-clip-text text-transparent">
          The process
        </h2>
