...
export default function WhatWeDoSection() {
  ...
  // Image paths - adjust these to match your actual image names
  const images = {
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-32 sm:h-40 md:h-48 lg:h-56 relative overflow-hidden">
              ...
              <div className="absolute inset-0">
                ...
                />
                {/* Dark overlay for better SVG visibility */}
              ...
              {/* Node-based pipeline */}
              <svg className="w-full h-full relative z-20" viewBox="0 0 200 120">
                <defs>
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-32 sm:h-40 md:h-48 lg:h-56 relative overflow-hidden">
              ...
              <svg className="w-full h-full relative z-20" viewBox="0 0 200 120">
                ...
                {/* Labels */}
                <text x="15" y="28" fill="rgba(255,255,255,0.7)" fontSize="9" fontWeight="300">Tone</text>
                <text x="15" y="58" fill="rgba(255,255,255,0.7)" fontSize="9" fontWeight="300">Palette</text>
                <text x="15" y="88" fill="rgba(255,255,255,0.7)" fontSize="9" fontWeight="300">Mood</text>

                {/* Tone slider bar */}
                <rect x="55" y="20" width="120" height="12" rx="6" fill="url(#toneGrad)" opacity="0.8"/>
                <circle
                  cx={105 + wave1}
                  cy="26"
                  r="7"
                ...
                {/* Palette color bar */}
                <rect x="55" y="50" width="120" height="12" rx="6" fill="url(#paletteGrad)" opacity="0.9"/>
                ...
                {/* Mood slider bar */}
                <rect x="55" y="80" width="120" height="12" rx="6" fill="url(#moodGrad)" opacity="0.7"/>
                <circle
                  cx={90 + wave2}
                  cy="86"
                  r="7"
                ...
                <g filter="url(#glowAccent)">
                  <circle cx="180" cy="56" r={12 + pulse * 4} fill="rgba(118, 196, 255, 0.2)"/>
                  <circle cx="180" cy="56" r={6 + pulse * 2} fill="rgba(118, 196, 255, 0.5)"/>
                </g>
              </svg>
            ...
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-28 sm:h-32 md:h-40 lg:h-44 relative overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-15 z-10">
                <div className="w-full h-full" style={{
                  backgroundImage: 'linear-gradient(rgba(118,196,255,0.4) 1px, transparent 1px), linear-gradient(90deg, rgba(118,196,255,0.4) 1px, transparent 1px)',
                  backgroundSize: '15px 15px'
                }}/>
              </div>

              <svg className="w-full h-full relative z-20" viewBox="0 0 120 80">
                {/* Desktop layout - transforms based on animation */}
                <g style={{
                  opacity: progress < 0.5 ? 1 : 0.3,
                  transform: `scale(${progress < 0.5 ? 1 : 0.9})`
                }}>
                  <rect x="5" y="8" width="42" height="28" rx="3" fill="rgba(118, 196, 255, 0.2)" stroke="rgba(118, 196, 255, 0.5)" strokeWidth="0.8"/>
                  <rect x="5" y="40" width="18" height="22" rx="3" fill="rgba(118, 196, 255, 0.15)" stroke="rgba(118, 196, 255, 0.4)" strokeWidth="0.5"/>
                  <rect x="27" y="40" width="18" height="22" rx="3" fill="rgba(118, 196, 255, 0.15)" stroke="rgba(118, 196, 255, 0.4)" strokeWidth="0.5"/>
                  <text x="24" y="72" textAnchor="middle" fill="rgba(118, 196, 255, 0.7)" fontSize="5">Desktop</text>
                </g>
                ...
                <g style={{
                  ...
                  <rect x="55" y="5" width="22" height="38" rx="3" fill="rgba(118, 196, 255, 0.25)" stroke="rgba(118, 196, 255, 0.6)" strokeWidth="0.8"/>
                  <rect x="58" y="8" width="16" height="12" rx="2" fill="rgba(118, 196, 255, 0.4)"/>
                  <rect x="58" y="23" width="16" height="6" rx="1" fill="rgba(118, 196, 255, 0.2)"/>
                  <rect x="58" y="32" width="16" height="6" rx="1" fill="rgba(118, 196, 255, 0.2)"/>
                  <text x="66" y="52" textAnchor="middle" fill="rgba(118, 196, 255, 0.7)" fontSize="5">Mobile</text>
                </g>
                ...
                <g style={{
                  ...
                  <rect x="85" y="8" width="28" height="48" rx="3" fill="rgba(118, 196, 255, 0.2)" stroke="rgba(118, 196, 255, 0.5)" strokeWidth="0.8"/>
                  <rect x="88" y="11" width="22" height="28" rx="2" fill="rgba(118, 196, 255, 0.35)"/>
                  <rect x="88" y="42" width="22" height="4" rx="1" fill="rgba(118, 196, 255, 0.6)"/>
                  <rect x="88" y="49" width="22" height="3" rx="1" fill="rgba(118, 196, 255, 0.3)"/>
                  <text x="99" y="66" textAnchor="middle" fill="rgba(118, 196, 255, 0.7)" fontSize="5">Ads</text>
                </g>
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-28 sm:h-32 md:h-40 lg:h-44 relative overflow-hidden">
              ...
              <svg className="w-full h-full relative z-20" viewBox="0 0 120 80">
                ...
                {/* Timeline base line */}
                <line x1="15" y1="35" x2="105" y2="35" stroke="rgba(118, 196, 255, 0.2)" strokeWidth="3" strokeLinecap="round"/>
                ...
                <g style={{ opacity: progress > 0.1 ? 1 : 0.5 }}>
                  <circle cx="25" cy="35" r="9" fill="rgba(118, 196, 255, 0.25)" stroke="rgba(118, 196, 255, 0.6)" strokeWidth="1.5"/>
                  <text x="25" y="39" textAnchor="middle" fill="rgba(118, 196, 255, 1)" fontSize="7" fontWeight="500">v1</text>
                  <text x="25" y="52" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="5">draft</text>
                  {/* Checkmark badge */}
                  <circle cx="33" cy="27" r="5" fill="rgba(34, 197, 94, 0.3)" stroke="rgba(34, 197, 94, 0.7)" strokeWidth="0.5"/>
                  <path d="M 30 27 L 32 29 L 36 24" stroke="rgba(34, 197, 94, 1)" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                </g>

                {/* Version 2 */}
                <g style={{ opacity: progress > 0.4 ? 1 : 0.4 }}>
                  <circle cx="55" cy="35" r="9" fill="rgba(118, 196, 255, 0.3)" stroke="rgba(118, 196, 255, 0.7)" strokeWidth="1.5"/>
                  <text x="55" y="39" textAnchor="middle" fill="rgba(118, 196, 255, 1)" fontSize="7" fontWeight="500">v2</text>
                  <text x="55" y="52" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="5">refined</text>
                  {/* Adjustment badge */}
                  <circle cx="63" cy="27" r="5" fill="rgba(251, 191, 36, 0.3)" stroke="rgba(251, 191, 36, 0.7)" strokeWidth="0.5"/>
                  <path d="M 60 27 L 66 27 M 63 24 L 63 30" stroke="rgba(251, 191, 36, 1)" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
                </g>
                ...
                <g filter={progress > 0.7 ? "url(#glowVersion)" : ""} style={{ opacity: progress > 0.7 ? 1 : 0.3 }}>
                  <circle
                    ...
                    fill="rgba(118, 196, 255, 0.35)"
                    stroke="#76c4ff"
                    strokeWidth="2"
                  />
                  <text x="85" y="39" textAnchor="middle" fill="#76c4ff" fontSize="7" fontWeight="600">v3</text>
                  <text x="85" y="52" textAnchor="middle" fill="rgba(118, 196, 255, 0.8)" fontSize="5">final</text>
                  {/* Star badge */}
                  <circle cx="93" cy="27" r="5" fill="rgba(118, 196, 255, 0.35)" stroke="rgba(118, 196, 255, 0.8)" strokeWidth="0.5"/>
                ...
                {/* Quality labels */}
                <text x="25" y="68" textAnchor="middle" fill="rgba(255,255,255,0.4)" fontSize="5">emotion</text>
                <text x="55" y="68" textAnchor="middle" fill="rgba(255,255,255,0.4)" fontSize="5">precision</text>
                <text x="85" y="68" textAnchor="middle" fill="rgba(255,255,255,0.45)" fontSize="5">nuance</text>
              </svg>
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-28 sm:h-32 md:h-40 lg:h-44 relative overflow-hidden">
              ...
              <svg className="w-full h-full relative z-20" viewBox="0 0 120 80">
                ...
                <line x1="35" y1="35" x2="85" y2="35" stroke="rgba(118, 196, 255, 0.3)" strokeWidth="2" strokeDasharray="6,4"/>
                ...
                {[0, 1, 2, 3].map(i => (
                  <circle
                    ...
                    r="2"
                    fill="#76c4ff"
                    opacity={0.5 + Math.sin(animationFrame * 0.1 + i) * 0.3}
                  />
                ))}

                {/* Human silhouette */}
                <g>
                  <circle cx="28" cy="22" r="12" fill="rgba(156, 163, 175, 0.2)" stroke="rgba(156, 163, 175, 0.4)" strokeWidth="1"/>
                  <circle cx="28" cy="18" r="5" fill="rgba(156, 163, 175, 0.5)"/>
                  <ellipse cx="28" cy="28" rx="7" ry="5" fill="rgba(156, 163, 175, 0.4)"/>
                  <text x="28" y="48" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="6">Expert</text>
                </g>

                {/* AI Node */}
                <g>
                  <rect x="75" y="20" width="24" height="24" rx="5" fill="rgba(118, 196, 255, 0.2)" stroke="rgba(118, 196, 255, 0.55)" strokeWidth="1"/>
                  <text x="87" y="36" textAnchor="middle" fill="rgba(118, 196, 255, 1)" fontSize="9" fontWeight="500">AI</text>
                  <text x="87" y="53" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="6">System</text>
                </g>

                {/* Review checklist */}
                <g>
                  <rect x="43" y="52" width="38" height="24" rx="3" fill="rgba(0, 0, 0, 0.8)" stroke="rgba(118, 196, 255, 0.35)" strokeWidth="0.8"/>
                  <text x="48" y="63" fill="rgba(255,255,255,0.75)" fontSize="6">✓ Quality</text>
                  <text x="48" y="72" fill="rgba(255,255,255,0.75)" fontSize="6">✓ Brand fit</text>
                </g>
