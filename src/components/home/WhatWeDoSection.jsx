...
export default function WhatWeDoSection() {
  ...
  useEffect(() => {
    ...
    let animationId;
    let lastTime = 0;
    const targetFPS = 12; // Lower FPS - still looks smooth
  ...
  // Memoized animation values - prevents recalculation
  ...
  const { wave1, wave2, wave3, pulse, progress } = animationValues;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 mb-3 md:mb-4">
          ...
          <Card1 
            ...
            pulse={pulse}
            image={images.card1}
            imageLoaded={imageLoaded.card1}
            imageError={imageError.card1}
            onImageLoad={() => handleImageLoad('card1')}
            onImageError={() => handleImageError('card1')}
          />
          ...
          <Card2
            ...
            pulse={pulse}
            image={images.card2}
            imageLoaded={imageLoaded.card2}
            imageError={imageError.card2}
            onImageLoad={() => handleImageLoad('card2')}
            onImageError={() => handleImageError('card2')}
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
          ...
          <Card3
            ...
            progress={progress}
            image={images.card3}
            imageLoaded={imageLoaded.card3}
            imageError={imageError.card3}
            onImageLoad={() => handleImageLoad('card3')}
            onImageError={() => handleImageError('card3')}
          />
          ...
          <Card4
            ...
            pulse={pulse}
            image={images.card4}
            imageLoaded={imageLoaded.card4}
            imageError={imageError.card4}
            onImageLoad={() => handleImageLoad('card4')}
            onImageError={() => handleImageError('card4')}
          />
          ...
          <Card5
            ...
            pulse={pulse}
            image={images.card5}
            imageLoaded={imageLoaded.card5}
            imageError={imageError.card5}
            onImageLoad={() => handleImageLoad('card5')}
            onImageError={() => handleImageError('card5')}
          />
        </div>
      </div>
    </section>
  ...
  <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
    <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-32 sm:h-40 md:h-48 lg:h-56 relative overflow-hidden">
      ...
      <svg className="w-full h-full relative z-10" viewBox="0 0 200 120">
        ...
        <circle cx={105 + wave1} cy="26" r="7" fill="#76c4ff"/>
