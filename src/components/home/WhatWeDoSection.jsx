...
// Image configuration for each card
const cardImages = {
  aiVisualEngines: {
    src: 'pfrotos/public/images/pfrotos..jpg',
    alt: 'Bespoke AI Visual Engines - Custom AI pipeline visualization',
  },
  brandCreativeDirection: {
    src: '/images/brand-creative-direction.webp',
    alt: 'Brand Calibrated Creative Direction - Tone and palette calibration',
  },
  adaptiveVisualLanguage: {
    src: '/images/adaptive-visual-language.webp',
    alt: 'Adaptive Visual Language Systems - Multi-platform design',
  },
  feedbackRefinement: {
    src: '/images/feedback-refinement.webp',
    alt: 'Feedback Refinement - Iterative improvement process',
  },
  expertsBackend: {
    src: '/images/experts-backend.webp',
    alt: 'Experts In The Backend - Human oversight and quality control',
  },
};
...
export default function WhatWeDoSection() {
  ...
  const [imageLoadStatus, setImageLoadStatus] = useState<Record<string, boolean>>({
    aiVisualEngines: true,
    brandCreativeDirection: true,
    adaptiveVisualLanguage: true,
    feedbackRefinement: true,
    expertsBackend: true,
  });
  ...
  // Handle image load error - switch to animation fallback
  const handleImageError = (cardKey: string) => {
    setImageLoadStatus(prev => ({ ...prev, [cardKey]: false }));
  };
  ...
  const CardImage = ({ 
    ...
    cardKey: keyof typeof cardImages;
    children: React.ReactNode;
  }) => {
    const imageConfig = cardImages[cardKey];
    const showImage = imageLoadStatus[cardKey];
        ...
        {showImage ? (
          <div className="relative w-full h-full">
            <Image
              ...
              priority={cardKey === 'aiVisualEngines' || cardKey === 'brandCreativeDirection'}
            />
          </div>
        ) : (
          // Animation fallback
  ...
  // Animation Components (extracted for cleaner code)
  const AIVisualEnginesAnimation = () => (
    <>
  ...
  const FeedbackRefinementAnimation = () => (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 mb-3 md:mb-4">
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-32 md:h-48 relative overflow-hidden">
              <CardImage cardKey="aiVisualEngines">
                <AIVisualEnginesAnimation />
              </CardImage>
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-32 md:h-48 relative overflow-hidden">
              <CardImage cardKey="brandCreativeDirection">
                <BrandCreativeAnimation />
              </CardImage>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-20 md:h-40 relative overflow-hidden">
              <CardImage cardKey="adaptiveVisualLanguage">
                <AdaptiveVisualAnimation />
              </CardImage>
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-20 md:h-40 relative overflow-hidden">
              <CardImage cardKey="feedbackRefinement">
                <FeedbackRefinementAnimation />
              </CardImage>
          ...
          <div className="group rounded-xl md:rounded-2xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/[0.08] hover:border-[#76c4ff]/30 p-3 md:p-6 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(118,196,255,0.15)]">
            <div className="rounded-lg md:rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 mb-3 md:mb-6 h-20 md:h-40 relative overflow-hidden">
              <CardImage cardKey="expertsBackend">
                <ExpertsBackendAnimation />
              </CardImage>
